...
public class InfectionPig extends Host {
    public static final String registryName="infection_pig";
    public InfectionPig(EntityType<? extends PathfinderMob> entityType, Level level) {
