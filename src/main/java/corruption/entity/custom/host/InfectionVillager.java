...
public class InfectionVillager extends Host implements GeoEntity {

    public static final String registryName="infection_villager";

    public InfectionVillager(EntityType<? extends PathfinderMob> entityType, Level level) {
