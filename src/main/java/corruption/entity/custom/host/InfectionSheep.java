...
public class InfectionSheep extends Host {
    public static final String registryName="infection_sheep";
    public InfectionSheep(EntityType<? extends PathfinderMob> entityType, Level level) {
